...
#define EC_LIST_FREE_FUNCTION_NAME(TYPE)            EC_CONCAT(TYPE, _List_Var_Free,)
#define EC_LIST_VAR_FREE_FUNCTION_NAME(TYPE)        EC_CONCAT(TYPE, _List_Var_Free_One,)
...
{                                                               \
    ...
    foreach_list (v)                                            \
    {                                                           \
        EC_LIST_VAR_FREE_FUNCTION_NAME(&v->var);                \
    }                                                           \
                                                                \
